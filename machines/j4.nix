{
  ...
  services.nfs.server.exports = ''
    /srv/nfs         192.168.0.0/16(rw,fsid=0,no_subtree_check,all_squash,anongid=1000,anonuid=100,sync)
    /srv/nfs/vpool   192.168.0.0/16(rw,nohide,insecure,no_subtree_check,all_squash,anongid=1000,anonuid=100,sync)
  '';
